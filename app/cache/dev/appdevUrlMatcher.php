...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // show
        if (0 === strpos($pathinfo, '/showoneart') && preg_match('#^/showoneart/(?P<id>[^/]+?)$#x', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'ISpySi\\WelcomeBundle\\Controller\\ArtController::showAction',)), array('_route' => 'show'));
        }

        // showArtByMediaType
        if (0 === strpos($pathinfo, '/showartbymedia') && preg_match('#^/showartbymedia/(?P<id>[^/]+?)$#x', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'ISpySi\\WelcomeBundle\\Controller\\ArtController::showArtAction',)), array('_route' => 'showArtByMediaType'));
        }

        // error
        if ($pathinfo === '/error') {
            return array (  '_controller' => 'ISpySi\\WelcomeBundle\\Controller\\DefaultController::errorAction',  '_route' => 'error',);
        }
